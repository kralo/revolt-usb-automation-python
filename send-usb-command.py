...
MSG_ID = hex(raw_id).split('x')[1].ljust(4,'0') #convert the id to hex but get rid of the '0x' at the beginning to be able to concatenate the message and make sure there are 4 characters (1 byte in hex)
...
summe = int(MSG_ID[:2],16)+int(MSG_ID[2:],16) + raw_action*16

raw_checksum = int(math.ceil(summe/256.0)*256)-summe-1
