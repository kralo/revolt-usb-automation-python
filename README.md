...
Python example to control wireless 433MHz power outlets. There also exists a [Java-Implementation](https://github.com/pfichtner/revolt-usb-automation-java) by [@pfichtner](https://github.com/pfichtner) .
